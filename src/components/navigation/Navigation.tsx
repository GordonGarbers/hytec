...
export const Navigation = () => {
  ...
  const y =
    ref.current && ref.current.children[btn.value].getBoundingClientRect().y+16;
    ...
    <>
      <nav style={{ top: '60px', zIndex:'2' }} className="position-fixed w-100">
        ...
        <motion.div
          ...
          style={{ maxWidth: '1400px', zIndex:'99999'}}
          data-menu={`${menu}`}
          className="container-fluid bg-grey-900 ps-3 ps-sm-5 pe-2 pe-sm-3 pt-3 pb shadow-lg shadow-sm-lg d-flex justify-content-center justify-content-sm-between align-items-center main-wrapper "
          >
            {/* <div style = {{height:'3px', top:'-3px', left:'0px'}} className='bg-primary position-absolute w-100'></div> */}

          <div className="mb-3 gap-4 gap-sm-0 language d-flex align-items-center">
          {/* <div style={{width:'120px'}} className = 'me-4'>
            <img style={{width:'100%', filter:'brightness(0%)', opacity:'.7'}} src = 'assets/hytec-yellow.webp' alt='img'/>
          </div> */}
            <div
              role="button"
              data-add-btn={false}
