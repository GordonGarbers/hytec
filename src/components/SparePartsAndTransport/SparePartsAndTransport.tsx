...
export const SparePartsAndTransport = () => {
  ...
  return (
    <div className="container-fluid-02 p-3 transport-container">
      <div className="w-100 my-5 rounded-2 overflow-hidden spare-wrapper spare-transport-wrapper">
        <div className="p-5 rounded-1 spare-transport-text-wrapper">
      ...
      <div className="w-100 my-5 rounded-2 overflow-hidden transport-wrapper spare-transport-wrapper">
        <div className="spare-transport-image-wrapper">
